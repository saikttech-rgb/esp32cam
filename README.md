...
[Возможности](#-возможности) • [Установка](#-установка) • [Использование](#-использование) • [API](#-api-endpoints) • [Безопасность](#-безопасность) • [FAQ](#-faq) 
...
### ⚠️ Важно: Эта система предназначена для домашнего использования и тестирования.  

HTTP Basic Auth использует base64 кодирование (НЕ шифрование)
WiFi пароль передаётся в открытом виде при первом подключении
